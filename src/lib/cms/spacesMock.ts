...
export const MOCK_SPACES: Record<string, SpaceContent> = {
  'the-lagos-executive': {
    ...
    gallery: [
      { id: 'le-1', url: '/spaces/lagos_exec_gal1.png', alt: 'The Lagos Executive depth perspective' },
      { id: 'le-2', url: '/spaces/lagos_exec_gal2.png', alt: 'The Lagos Executive material context' }
    ],
  ...
  'the-warm-reading-nook': {
    ...
    gallery: [
      { id: 'rn-1', url: '/spaces/reading_nook_gal1.png', alt: 'The Warm Reading Nook perspective' },
      { id: 'rn-2', url: '/spaces/reading_nook_gal2.png', alt: 'The Warm Reading Nook detail' }
    ],
    productHandles: ['the-boucle-chair', 'the-tapered-side-table', 'the-wavy-bookshelf']
  },
  'the-brutalist-study': {
    ...
    gallery: [
      { id: 'bs-1', url: '/spaces/brutalist_study_gal1.png', alt: 'The Brutalist Study angle' },
      { id: 'bs-2', url: '/spaces/brutalist_study_gal2.png', alt: 'The Brutalist Study texture' }
    ],
